...
# arecord -D hw:CARD=Microphone,DEV=0 -f S16_LE -r 384000 -d 60 /home/canopylife/data/curdat/Audio/$filename # Ultrasound / microMoth
arecord -D hw:CARD=Microphone,DEV=0 -f S16_LE -r 48000 -d 60 /home/canopylife/data/curdat/Audio/$filename # Lavalier microphone

echo $location", "$serialNum", audio, "$filename", AudioMoth, S16_LE, 48000, 60" >> /home/canopylife/data/curdat/dataLog.csv
echo $location", "$serialNum", audio, "$filename", AudioMoth, S16_LE, 48000, 60" 
